                            ...
                            onDelete = {
                                ...
                                scope.launch {
                                    val result = snackbarHostState.showSnackbar(
                                        ...
                                        duration = androidx.compose.material3.SnackbarDuration.Short // Importar SnackbarDuration
                                    )
...
fun TaskItem(task: Task, onToggleCompletion: () -> Unit, onDelete: () -> Unit) {
    val scale by animateFloatAsState(targetValue = if (task.isCompleted) 1.05f else 1f, label = "scaleAnimation") // Added label for animateFloatAsState
